...
- **Infrastructure (M6)**: `cauterule corpus` CLI group, `cauterule benchmark` CLI + leaderboard, pytest-benchmark perf-regression CI, `cauterule release` CLI + tag/publish workflow + TestPyPI, OpenTelemetry standalone exporter, cost/latency tiering guidance (#486, #588, #601, #605-#606)
