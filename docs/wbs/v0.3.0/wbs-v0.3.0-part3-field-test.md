...
| # | Task | Issue |
|---|------|-------|
| 7.1 | Create field test plan — methodology, corpus plan, thresholds, scoring | [#625](https://github.com/deghosal-2026/CauterRule/issues/625) |
| 7.2 | Update field test runner scripts for v0.3.0 changes | [#629](https://github.com/deghosal-2026/CauterRule/issues/629) |
| 7.3 | Update corpus for v0.3.0 field test — packs/adapters/lifecycle safety | [#635](https://github.com/deghosal-2026/CauterRule/issues/635) |
| 7.4 | Docker test plan — container validation, compose scenarios, image size, multi-arch | [#641](https://github.com/deghosal-2026/CauterRule/issues/641) |
| 7.5 | Create and run Docker tests — compose suites, CLI smoke, preflight, full pipeline | [#642](https://github.com/deghosal-2026/CauterRule/issues/642) |
