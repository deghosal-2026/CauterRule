...
- **M2 (Evaluation & Field Test): open** — **60 issues**: 4 original evaluation tickets + 13 field-test tickets + **43 from the `[0.3.1-M2-CodeReview]` audit** (#762, #763-#804). 11 Critical (10 code-review + #762), 32 Important. **10/11 Criticals fixed** (#763, #764, #769, #770, #775, #776, #777, #778, #791, #795); #762 Phase 0 done (Phase 1 deferred).
